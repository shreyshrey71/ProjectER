...
public class RelayInvert extends AppCompatActivity {
    ...
    public void resultdisp()
    {
        ...
        mydb.insertData("1",""+((counter-1)/elapsed),""+elapsed,""+(counter-1),"4",""+res.getCount());
        Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                ...
                switch (r) {
                    case 0: {
                        ...
                        button0.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {if (viewpar.getId() == counter && wrong == 0) {
                                counterfunc();
                                counter++;
                                recVal = 1;
